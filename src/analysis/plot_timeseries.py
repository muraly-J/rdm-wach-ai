...
# Paths adjusted for: rdm-wach-ai/src/analysis/plot_timeseries.py
# Navigation: Go up twice (../../) to reach root, then into data/cleaned/
report_path = "data/reports/"
plot_path = report_path + "plots/"
os.makedirs(plot_path, exist_ok=True)

# Path to the parquet data in rdm-wach-ai/data/cleaned/
files = glob.glob("data/cleaned/*.parquet")

# # --- DEBUG LINES ---
# print("Current Working Directory:", os.getcwd())
# print("Looking for files in:", os.path.abspath("data/cleaned/"))
# print("Files found:", files)
# # -------------------

# if not files:
#     print("ERROR: No parquet files found. Check your folder names!")
